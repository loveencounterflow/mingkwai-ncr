...
(function() {
  ...
  (() => {    //===========================================================================================================
    ...
    (() => {      //.........................................................................................................
      var cache;
      cache = {};
      return MKNCR.describe = function(...P) {
        /* TAINT what about gaiji? */
        var R, csg, id, key, nfo, ref, rsg, t, tag, value;
        id = JSON.stringify(P);
        if ((R = cache[id]) != null) {
          return R;
        }
        ...
        if ((rsg === 'u-pua') || (csg !== 'u')) {
          ...
          if (indexOf.call(tag, 'ideograph') < 0) {
            tag.push('ideograph');
          }
          R['tag'] = (function() {
            var j, len1, results;
  ...
  //-----------------------------------------------------------------------------------------------------------
  read_cache = function(handler = null) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  rewrite_cache = function(handler = null) {
    var S;
...
//.........................................................................................................
    ...
    */
    ...
    $add_intervals = () => {
      return $('null', (phrase, send) => {
        var ctag, mtag, otag, source_cid, source_glyph, target_cid, target_glyph;
        if (phrase == null) {
          return handler(null, S);
        }
        send(phrase);
        [target_glyph, otag, source_glyph] = phrase;
  ...
  glyph_style_as_tex = function(glyph, glyph_style) {
    var R, ref, ref1, ref2, ref3, rpl_chr, rpl_cmd, rpl_push, rpl_raise;
    ...
    if ((rpl_push != null) && (rpl_raise != null)) {
      R.push(`\\mktstfPushRaise{${rpl_push}}{${rpl_raise}}`);
    } else if (rpl_push != null) {
      R.push(`\\mktstfPush{${rpl_push}}`);
    } else if (rpl_raise != null) {
      R.push(`\\mktstfRaise{${rpl_raise}}`);
    }
    //.........................................................................................................
    if (rpl_cmd != null) {
      R.push(`\\${rpl_cmd}{}`);
