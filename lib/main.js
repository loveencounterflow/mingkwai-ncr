...
(function() {
  var $, $async, CND, D, FS, ISL, MKNCR, NCR, PATH, _get_aggregate, badge, block_style_as_tex, debug, demo, demo_2, echo, get_file_age, glyph_style_as_tex, info, log, populate_isl, populate_isl_with_sims, populate_isl_with_tex_formats, read_cache, rewrite_cache, rpr, step, u, urge;
  ...
  populate_isl_with_tex_formats = function(S, handler) {
    var block_command, cid, entry, glyph, glyph_style, glyph_style_tex, glyph_styles, hi, i, key, len, lo, mkts_options, ref, rsg, tex, tex_command_by_rsgs;
