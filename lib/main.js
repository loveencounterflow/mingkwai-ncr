...
(function() {
  var $, $async, CND, D, FS, ISL, MKNCR, NCR, PATH, badge, block_style_as_tex, debug, echo, glyph_style_as_tex, help, info, log, main, new_state, populate_isl_with_extra_data, populate_isl_with_sims, populate_isl_with_tex_formats, read_cache, rewrite_cache, rpr, step, u, urge, warn,
    slice = [].slice;
  ...
  populate_isl_with_sims = function(S, handler) {
    var $add_intervals, $collect_tags, SIMS, input;
    ...
    input = SIMS.new_readstream(null, {
      gaiji: false
    });
