...
(function() {
  var $, $async, CND, D, FS, ISL, MKNCR, NCR, PATH, badge, block_style_as_tex, debug, echo, get_file_time, glyph_style_as_tex, help, info, log, populate_isl, populate_isl_with_extra_data, populate_isl_with_sims, populate_isl_with_tex_formats, read_cache, rewrite_cache, rpr, step, u, urge, warn,
    slice = [].slice;
  ...
  populate_isl_with_tex_formats = function(S, handler) {
    var block_command, cid, entry, fallback_command, glyph, glyph_style, glyph_style_tex, glyph_styles, hi, i, len, lo, mkts_options, ref, ref1, rsg, tex, tex_command_by_rsgs;
