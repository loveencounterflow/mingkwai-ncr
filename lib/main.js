...
(function() {
  var $, $async, CND, D, FS, ISL, MKNCR, NCR, PATH, badge, block_style_as_tex, debug, echo, get_file_age, glyph_style_as_tex, help, info, log, populate_isl, populate_isl_with_sims, populate_isl_with_tex_formats, read_cache, rewrite_cache, rpr, step, u, urge, warn;
  ...
  populate_isl = function(handler) {
    var S, cache_age, cache_path, must_rewrite_cache, source_age;
    S = {
      paths: {
