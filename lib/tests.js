...
(function() {
  ...
  this["MojiKura get_set_of_CJK_ideograph_cids includes u-cjk-cmpi2"] = function(T) {
    var L, cid, cjk_cids, description, fncr, glyph, i, len, probes_and_matchers, ref, result;
    probes_and_matchers = [['u-cjk-cmpi2/2f801', '丸', null], ['u-cjk-cmpi1/f9ba', '了', null], ['u-cjk-rad1/2f08', '⼈', null]];
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref = probes_and_matchers[i], fncr = ref[0], glyph = ref[1], result = ref[2];
      cid = MKNCR.as_cid(glyph);
  ...
  if (module.parent == null) {
    include = ["aggregate", "SIMs, TeX formats", "jzr_as_xncr", "descriptions (2)", "MojiKura get_set_of_CJK_ideograph_cids includes u-cjk-cmpi2"];
    this._prune();
    this._main();
  }
